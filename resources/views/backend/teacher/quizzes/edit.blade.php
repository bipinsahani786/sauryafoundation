<x-dashboard.layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('teacher.quizzes.index') }}" class="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-colors">
    ...
    <form action="{{ route('teacher.quizzes.update', $quiz->id) }}" method="POST">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden p-8">
            ...
            <div x-data="{ isContest: {{ $quiz->is_contest ? 'true' : 'false' }} }" class="mb-8 p-6 bg-slate-50 rounded-2xl border border-slate-100">
