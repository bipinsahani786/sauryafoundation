<x-dashboard.layout>
    <x-slot name="title">Add New Sector</x-slot>

    <div class="mb-6">
        <h2 class="text-xl font-bold text-slate-900 tracking-tight">Create Landing Page Sector</h2>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <form action="{{ route('admin.home-sectors.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" required class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all" placeholder="e.g. Marriage Halls & Banquets">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Slug (URL Name - Optional)</label>
                            <input type="text" name="slug" value="{{ old('slug') }}" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all" placeholder="e.g. marriage-halls">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="2" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all" placeholder="Briefly describe the sector">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Sector Image</label>
                        ...
                        <div>
                            ...
                            <input type="text" name="tag" value="{{ old('tag') }}" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all" placeholder="e.g. Yield Focused">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6 bg-slate-50 p-6 rounded-xl border border-slate-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="stats[yield]" value="{{ old('stats.yield', '21.5%') }}" class="w-full bg-white border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 outline-none transition-all" placeholder="e.g. 21.5%">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Asset Class</label>
                            <input type="text" name="stats[asset_class]" value="{{ old('stats.asset_class', 'Institutional') }}" class="w-full bg-white border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 outline-none transition-all" placeholder="e.g. Institutional">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Transparency</label>
                            <input type="text" name="stats[transparency]" value="{{ old('stats.transparency', '100%') }}" class="w-full bg-white border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 outline-none transition-all" placeholder="e.g. 100%">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Exit Window</label>
                            <input type="text" name="stats[exit_window]" value="{{ old('stats.exit_window', 'T+5 Yr') }}" class="w-full bg-white border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 outline-none transition-all" placeholder="e.g. T+5 Yr">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="link" value="{{ old('link') }}" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all" placeholder="e.g. sectors.marriage-halls">
                        </div>
                        <div>
                ...
                <div class="mt-8 pt-8 border-t border-slate-100 flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-3 bg-indigo-600 text-white rounded-lg text-xs font-bold shadow-sm hover:bg-indigo-700 transition-all">Create Sector</button>
                </div>
            </form>
        </div>
    </div>
