        ...
        <div class="max-w-sm w-full relative z-10" data-aos="zoom-in">
            <div class="glass-card p-8 rounded-[2.5rem] border-brand-primary/20 shadow-2xl">
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-2xl font-black text-slate-900 mb-1 tracking-tighter">Member Login</h2>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            <i class="fas fa-user-shield absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-brand-primary transition-colors text-[10px]"></i>
                            <input type="email" name="email" placeholder="email@shaurya.in" class="w-full bg-slate-50 border border-slate-200 rounded-full pl-10 pr-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-brand-primary focus:bg-white outline-none transition-all shadow-sm font-medium text-xs" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            <i class="fas fa-key absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-brand-accent transition-colors text-[10px]"></i>
                            <input type="password" name="password" placeholder="••••••••" class="w-full bg-slate-50 border border-slate-200 rounded-full pl-10 pr-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-brand-accent focus:bg-white outline-none transition-all shadow-sm font-medium text-xs" required>
                        </div>
                    </div>
                    ...
                    <div class="text-center pt-2">
                        <p class="text-slate-500 text-[9px] font-bold uppercase tracking-widest">
                            New Member? <a href="{{ route('register') }}" class="text-slate-900 hover:text-brand-accent transition-colors underline decoration-brand-accent underline-offset-4 ml-1">Register Now</a>
                        </p>
                    </div>
                </form>
            </div>
            
            <p class="text-center mt-8 text-[8px] text-slate-400 uppercase tracking-[0.4em] font-black">Encrypted Channel Secure</p>
        </div>
    </div>
</x-frontend.layout>
