                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex-1">
                                <input type="text" name="icon" id="icon_input" value="{{ old('icon', $homeSector->icon) }}" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all" placeholder="e.g. fas fa-hotel">
                            </div>
                    ...
                    <div>
                        ...
                        <div class="prose-editor">
                            <textarea name="content" id="editor">{{ old('content', $homeSector->content) }}</textarea>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (editorElement) {
                ClassicEditor
                    ...
                    .then(editor => {
                        console.log('Editor initialized component:', editor);
                    })
                    .catch(error => {
